...
Build `2026-09-22an`. Suite 786/789 plus eng5 6/6, measured 22 Sep 2026. Three sessions ran long and the
...
Measured 22 Sep 2026 on build `2026-09-22an`, `profiles.json` at the root, current `nodal/`.
...
validate_invariants     172/172   shed-energy cost; ORDC reads available reserve; market-basis cost recovery; curtailment compensation
